...
[IMPORANT]
====
Starting with Scala 2.11.0, the Scala https://docs.scala-lang.org/overviews/core/actors.html[Actors] library is deprecated. Already in Scala 2.10.0 the default actor library is https://akka.io/[Akka].
