...
[source,scala]
----
scala> val nums = new Cell(123.45)
nums: Cell[Double] = Cell@6334a8ab

scala> val nums = new Cell[Any](123.45)
nums: Cell[Any] = Cell@69ca15d7

scala> val name = nums.set("the Mayor Hotline")
name: Cell[Any] = Cell@466b7ca

scala> name.get
res5: Any = the Mayor Hotline
