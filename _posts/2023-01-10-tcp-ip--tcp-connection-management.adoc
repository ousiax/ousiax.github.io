...
====
+
[source,console,highlight="5,17"]
----
x@node-0:~$ socat - tcp-listen:6666,fork,reuseaddr,backlog=1 2>&1 > /tmp/1
^Z
[1]+  Stopped                 socat - tcp-listen:6666,fork,reuseaddr,backlog=1 2>&1 > /tmp/1
x@node-0:~$ ps aux | grep socat
x           2313  0.0  0.0   8796  2332 pts/2    T    17:28   0:00 socat - tcp-listen:6666,fork,reuseaddr,backlog=1
x           2320  0.0  0.0   6244   704 pts/2    S+   17:28   0:00 grep socat
x@node-0:~$ netstat -ntl4
...
LISTEN          0               128                              0.0.0.0:4000                           0.0.0.0:*              users:(("ruby",pid=833,fd=11))           
LISTEN          0               1                                0.0.0.0:6666                           0.0.0.0:*              users:(("socat",pid=2313,fd=5))          
LISTEN          0               100                              0.0.0.0:35729                          0.0.0.0:*              users:(("ruby",pid=833,fd=18))           
LISTEN          0               128                              0.0.0.0:22                             0.0.0.0:*                                                       
x@node-0:~$ tail -f /tmp/1 
----
