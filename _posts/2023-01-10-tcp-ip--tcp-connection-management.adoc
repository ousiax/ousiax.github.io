...
[NOTE]
====
Most modern operating systems support some form of network offloading, where some network processing happens on the NIC instead of the CPU. <<offloading>><<segmentation-offloading-with-wireshark-and-ethtool>><<lab-15>>
...
* [[[offloading,3]]] https://wiki.wireshark.org/CaptureSetup/Offloading
* [[[segmentation-offloading-with-wireshark-and-ethtool,4]]] https://sandilands.info/sgordon/segmentation-offloading-with-wireshark-and-ethtool
* [[[lab-15,5]]] http://ce.sc.edu/cyberinfra/workshops/Material/NTP/Lab%2015.pdf
* [[[generic_segmentation_offload_lib,6]]] https://doc.dpdk.org/guides/prog_guide/generic_segmentation_offload_lib.html
* [[[segmentation-offloads,7]]] https://docs.kernel.org/networking/segmentation-offloads.html
