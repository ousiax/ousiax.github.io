...
[source,console]
----
$ cat header.json | base64 -w 0 | tr -d '='
ewogICJhbGciOiAiSFMyNTYiLAogICJ0eXAiOiAiSldUIgp9Cg
----
...
[source,console]
----
$ cat payload.json | base64 -w 0 | tr -d '='
ewogICJzdWIiOiAiMTIzNDU2Nzg5MCIsCiAgIm5hbWUiOiAiSm9obiBEb2UiLAogICJhZG1pbiI6IHRydWUKfQo
----
