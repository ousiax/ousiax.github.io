...
# lvs
  LV           VG     Attr       LSize   Pool Origin Data%  Meta%  Move Log Cpy%Sync Convert
  thinpool     docker -wi-a-----  28.49g                                                    
  thinpoolmeta docker -wi-a----- 304.00m            
----
...
# lvs
  LV       VG     Attr       LSize  Pool Origin Data%  Meta%  Move Log Cpy%Sync Convert
  thinpool docker twi-a-t--- 28.49g             0.00   5.28    
----
...
# lvs -v
  LV       VG     #Seg Attr       LSize  Maj Min KMaj KMin Pool Origin Data%  Meta%  Move Cpy%Sync Log Convert LV UUID                                LProfile       
  thinpool docker    1 twi-a-t--- 28.49g  -1  -1  254    2             0.00   5.28                             6Bc4oY-boP1-IpU1-tShb-cg9L-Jleb-ryr5H3 docker-thinpool
----
...
# lvs -o+seg_monitor
  ...
  thinpool docker twi-a-t--- 28.49g             0.00   5.28                             monitored
----
...
<...>
 ...
 Storage Driver: devicemapper
  ...
  Data Space Total: 30.59GB
  Data Space Available: 30.35GB
  Metadata Space Used: 16.86MB
  Metadata Space Total: 318.8MB
  Metadata Space Available: 301.9MB
  Thin Pool Minimum Free Space: 3.059GB
  Deferred Removal Enabled: true
  Deferred Deletion Enabled: true
  Deferred Deleted Device Count: 0
  Library Version: 1.02.175 (2021-01-08)
...
tmpfs           391M  980K  390M   1% /run
/dev/sdc1        98G   62G   32G  67% /
tmpfs           2.0G     0  2.0G   0% /dev/shm
tmpfs           5.0M     0  5.0M   0% /run/lock
tmpfs           391M  4.0K  391M   1% /run/user/1000

# docker run -d --rm nginx
1e607905907150e645ef9b21641eea7da0e67176a9d84994a4396ba65dd4bb1e
# docker run -d --rm nginx
b37be054f907b7f050f46fe983619ec21cb8eb031a3e08f8910bbdea31e1e7ce
# docker run -d --rm nginx
2e2cb2d0c8487bed16269b9ef05ae7efc292f6edae52aa702cff64188d56ea72
# docker run -d --rm nginx
d3387890e4ec5e04083e20f073b83d738b960b40b9e605977e05fbf74c13efe4

# docker ps -s
CONTAINER ID   IMAGE     COMMAND                  CREATED              STATUS              PORTS     NAMES                SIZE
d3387890e4ec   nginx     "/docker-entrypoint.…"   About a minute ago   Up About a minute   80/tcp    vibrant_ellis        1.09kB (virtual 141MB)
2e2cb2d0c848   nginx     "/docker-entrypoint.…"   About a minute ago   Up About a minute   80/tcp    intelligent_hoover   1.09kB (virtual 141MB)
b37be054f907   nginx     "/docker-entrypoint.…"   About a minute ago   Up About a minute   80/tcp    crazy_hertz          1.09kB (virtual 141MB)
1e6079059071   nginx     "/docker-entrypoint.…"   About a minute ago   Up About a minute   80/tcp    admiring_bassi       1.09kB (virtual 141MB)
...
tmpfs           5.0M     0  5.0M   0% /run/lock
tmpfs           391M  4.0K  391M   1% /run/user/1000
/dev/dm-3       9.8G  148M  9.1G   2% /var/lib/docker/devicemapper/mnt/c265f0f52c442fb87e8a73f6dbac7444a42c9b623ca843f514e26dc746c6fc2d
/dev/dm-4       9.8G  148M  9.1G   2% /var/lib/docker/devicemapper/mnt/d9abc8be04e4633a01417c19ef8dbebaf7d2f643d06dda6d367cb99470cb9bd6
/dev/dm-5       9.8G  148M  9.1G   2% /var/lib/docker/devicemapper/mnt/5c25217f2211de7e4b33c0554bb47eb3f733e4069f67d615b80b9f58a7008bb5
/dev/dm-6       9.8G  148M  9.1G   2% /var/lib/docker/devicemapper/mnt/d9fb543a0b0bee229da02e7ce705b3b222967d49b085b894a88179ed86e4bc4f
----
