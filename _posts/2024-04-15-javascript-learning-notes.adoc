...
TIP: https://www.typescriptlang.org/[TypeScript] stands in an unusual relationship to JavaScript. TypeScript offers all of JavaScript’s features, and an additional layer on top of these: TypeScript’s type system.
...
```console
success: installed pnpm@9.0.5 with executables: pnpm, pnpx
```
