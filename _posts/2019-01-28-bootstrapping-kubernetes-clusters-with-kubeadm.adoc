...
* [[[ingress-nginx-via-the-host-network,13]]] https://kubernetes.github.io/ingress-nginx/deploy/baremetal/#via-the-host-network
* [[[cluster-logging,14]]] https://kubernetes.io/docs/concepts/cluster-administration/logging/
