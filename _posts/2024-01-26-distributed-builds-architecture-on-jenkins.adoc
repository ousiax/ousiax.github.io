...
=== Configuring a Jenkins SSH credential
...
=== Configuring agents using the SSH connector in Docker
...
+
```console
agent1 seems to be running inside container b96e89256268ae53285cfc89cbf804bbeffb120edd641d7261ced2ddac7d6406
but /home/jenkins/agent/workspace/jenkins-getting-started_main could not be found among []
but /home/jenkins/agent/workspace/jenkins-getting-started_main@tmp could not be found among []
. . .
