...
TIP: In other languages, dictionaries might be called _associative arrays_, _hashes_, or _hashmaps_. In Python, a dictionary is also called a _dict_ to save syllables and make teenage boys snicker.
