...
* The leftmost component, separated by periods, in a package import path is still relative to a directory included in the `sys.path` module search path list.
+
```py
