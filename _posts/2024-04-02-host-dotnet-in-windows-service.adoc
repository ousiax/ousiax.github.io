...
* [[[aspnet-windows-service,6]]] https://learn.microsoft.com/en-us/aspnet/core/host-and-deploy/windows-service
* [[[aspnet-static-files,7]]] https://learn.microsoft.com/en-us/aspnet/core/fundamentals/static-files
* [[[dotnet-windows-service-with-installer,8]]] https://learn.microsoft.com/en-us/dotnet/core/extensions/windows-service-with-installer
* [[[wixtoolset-signing,9]]] https://wixtoolset.org/docs/tools/signing/
* [[[sdk-signtool,10]]] https://learn.microsoft.com/en-us/windows/win32/seccrypto/signtool
* [[[digitally-sign-msi-installers-with-code-signing,11]]] https://codesigningstore.com/digitally-sign-msi-installers-with-code-signing
