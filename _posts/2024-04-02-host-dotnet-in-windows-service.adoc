...
An installer bundles your app's executables and exposes a customizable installation user experience. <<dotnet-windows-service-with-installer>>
...
* Create a WiX source file `Package.wxs` under the `Example.WebApp` project
+
```xml
